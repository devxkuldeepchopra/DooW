...
function youtubeConfig($content) {
    ...
    if($post){
        ...
        $postViewConntent = '<div class="post-col col-rb" id="post-col"><a href="'.$tutorialLink.'"><div class="ads ads-head">'.$ads.'</div></a>
        ...
        $postViewConntent.='<div id="disqus_thread"></div>'.$disqus.'</div>';
